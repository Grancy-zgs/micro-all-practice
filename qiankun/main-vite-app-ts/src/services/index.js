...
export const getSystemList = async () => {
  return {
    data: [
      ...
      // {
      //   systemId: 'vite-test-app',
      //   name: 'vite-test-app',
      //   productionEntry: '/child/vite-test-app/',
      //   developmentEntry: '//localhost:6000/',
      //   title: 'vite-test-app',
      //   path: '/vite-test-app/about',
      //   normal: 'images/module/dvs-village-normal.png',
      //   selected: 'images/module/dvs-village-selected.png',
      //   enabled: true
      // },
      {
        systemId: 'vite-test-plugin',
        name: 'vite-test-plugin',
        productionEntry: '/child/vite-test-plugin/',
        developmentEntry: '//localhost:7000/',
        title: 'vite-test-plugin',
